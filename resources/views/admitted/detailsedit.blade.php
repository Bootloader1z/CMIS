...
<table class="table table-bordered">
    <tbody>
        <tr>
            <th>Admitted No.</th>
            <td>
                <input type="text" class="form-control" id="admittedno{{ $recentViolationsToday->id }}" name="admittedno" value="{{ $recentViolationsToday->admittedno }}">
            </td>
        </tr>
        <tr>
            <th>TOP</th>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control" id="apprehending_officer{{ $recentViolationsToday->id }}" name="apprehending_officer" value="{{ $recentViolationsToday->apprehending_officer }}">
            </td>
        </tr>
    </tbody>
</table>
...
<table class="table table-bordered">
    <tbody>
        <tr>
            ...
            <td>
                <input type="text" class="form-control" id="transaction_no{{ $recentViolationsToday->id }}" name="transaction_no" value="{{ $recentViolationsToday->transaction_no }}">
            </td>
        </tr>
        <tr>
            <th>Date Received</th>
            <td>
                <input type="date" class="form-control" id="date_received{{ $recentViolationsToday->id }}" name="date_received" value="{{ $recentViolationsToday->date_received }}">
            </td>
        </tr>
        <tr>
            <th>Plate No.</th>
            <td>
                <input type="text" class="form-control" id="plate_no{{ $recentViolationsToday->id }}" name="plate_no" value="{{ $recentViolationsToday->plate_no }}">
            </td>
        </tr>
        <tr>
            <th>Contact No.</th>
            <td>
                <input type="text" class="form-control" id="contact_no{{ $recentViolationsToday->id }}" name="contact_no" value="{{ $recentViolationsToday->contact_no }}">
            </td>
        </tr>
        <tr>
<th>Remarks 
