<script>
    // Check if the user is logged in using Laravel's Auth status
    @if(Auth::check())
        // Redirect to the dashboard if logged in
        window.location.href = '{{ route('dashboard') }}'; // Change 'dashboard' to the correct route name for your dashboard
    @else
        // You can add code here to show content for guests or show a login form
